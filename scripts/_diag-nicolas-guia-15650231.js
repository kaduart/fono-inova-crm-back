...
async function main() {
  ...
  const guide = await InsuranceGuide.findOne({ number: '15650231', patientId: patient._id }).lean();
  console.log('Guia 15650231:', guide);
  ...
  console.log(`\nSessoes da guia 15650231 (${sessions.length}):`);

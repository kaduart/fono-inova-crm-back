...
async function main() {
  ...
  const CORRECT_VALUE = 80;
  const WRONG_VALUE = 100;

  // 1. Appointments do Nicolas Lucca com sessionValue ou insuranceValue 100
  ...
  // 2. Payments do Nicolas Lucca com amount ou insurance.grossAmount 100
  ...
  // 3. Guias usadas por esses appointments com sessionValue 100

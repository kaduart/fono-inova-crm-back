...
async function main() {
  ...
  const filenameMD = `tests-amanda-ouro/relatorios/RELATORIO-QNA-V8-${timestamp}.md`;
  ...
  const filenameJSON = `tests-amanda-ouro/relatorios/RELATORIO-QNA-V8-${timestamp}.json`;
